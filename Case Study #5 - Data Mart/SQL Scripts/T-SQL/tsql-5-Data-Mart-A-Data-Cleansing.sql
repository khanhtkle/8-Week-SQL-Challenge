...
-------------------------------------
--	In a single query, perform the following operations and generate a new table the `data_mart` schema named `weekly_sales`:
...
DROP TABLE IF EXISTS data_mart.dbo.cleaned_weekly_sales;
...
INTO data_mart.dbo.cleaned_weekly_sales
FROM data_mart.dbo.weekly_sales;

SELECT * 
FROM data_mart.dbo.cleaned_weekly_sales
ORDER BY week_date;
