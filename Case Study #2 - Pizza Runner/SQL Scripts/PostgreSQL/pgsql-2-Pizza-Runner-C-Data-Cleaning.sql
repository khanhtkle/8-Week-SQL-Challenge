...
--		- Convert the data type of the value extracted from the UNNEST and STRING_TO_ARRAY function for `toppings` from TEXT to INTEGER.
...
--		- Convert the data type of the value extracted from the UNNEST and STRING_TO_ARRAY function for `extras` from VARCHAR(4) to INTEGER.
...
--		- Convert the data type of the value extracted from the UNNEST and STRING_TO_ARRAY function for `exclusions` from VARCHAR(4) to INTEGER.
